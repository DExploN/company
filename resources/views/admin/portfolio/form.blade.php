...
<div class="form-group row">
    ...
    <input class="form-control col-sm-10" id="year" name="year" value="{{$portfolio->year}}"/>
</div>

<div class="form-group row">
    <label for="android_link" class="col-form-label col-sm-2">@lang('Android link')</label>
    <input class="form-control col-sm-10" id="android_link" name="android_link" value="{{$portfolio->android_link}}"/>
</div>

<div class="form-group row">
    <label for="apple_link" class="col-form-label col-sm-2">@lang('Apple link')</label>
    <input class="form-control col-sm-10" id="apple_link" name="apple_link" value="{{$portfolio->apple_link}}"/>
</div>
